				...
				<div class="container">
					<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="welcome">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="blog_home"> Blog Home</a></p>
						</div>											
					</div>
				</div>
			</section>
					...
					<div class="row">
						<div class="col-lg-8 post-list blog-post-list">
							<div class="single-post">
								<img class="img-fluid" src="assets/img/blog/p1.jpg" alt="">
								<ul class="tags">
									<li><a href="#">Art, </a></li>
							...
							<div class="single-post">
								<img class="img-fluid" src="assets/img/blog/p2.jpg" alt="">
								<ul class="tags">
									<li><a href="#">Art, </a></li>
									<li><a href="#">Technology, </a></li>
									<li><a href="#">Fashion</a></li>
							...
							<div class="single-post">
								<img class="img-fluid" src="assets/img/blog/p3.jpg" alt="">
								<ul class="tags">
									<li><a href="#">Art, </a></li>
									<li><a href="#">Technology, </a></li>
									<li><a href="#">Fashion</a></li>
							...
							<div class="single-post">
								<img class="img-fluid" src="assets/img/blog/p4.jpg" alt="">
								<ul class="tags">
									<li><a href="#">Art, </a></li>
									<li><a href="#">Technology, </a></li>
									<li><a href="#">Fashion</a></li>
						...
						<div class="col-lg-4 sidebar">
							...
							<div class="single-widget protfolio-widget">
								<img src="assets/mg/blog/user2.jpg" alt="">
