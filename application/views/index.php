			    	...
			    	<div class="row align-items-center justify-content-between d-flex">
				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li><a href="application/view/about.html">About</a></li>
							...
							<form class="form" role="form" autocomplete="off">
							    <div class="form-group">
							       	<div class="default-select" id="default-select"">
										<select>
											<option value="" disabled selected hidden>Pilih mobil sekarang juga</option>
											<option value="1">Innova</option>
											<option value="1">Mobilio</option>
											<option value="1">Terios</option>
							    ...
							    <div class="form-group row">
							        <div class="col-md-6 wrap-left">
								       	<div class="default-select" id="default-select"">
											<select>
												<option value="" disabled selected hidden>Mulai</option>
							    ...
							    <div class="form-group row">
							        <div class="col-md-12">
							            <button type="reset" class="btn btn-default btn-lg btn-block text-center text-uppercase">Konfirmasi</button>
							        </div>
							    </div>
							</form>
						</div>											
				...
				<div class="container">
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 single-blog">
							...
							<a href="https://www.semisena.com/12/tips-mengemudi-mobil-jarak-jauh.html"><h4>Tips Mengemudi Mobil Jarak Jauh</h4></a>
							<p>
						...
						<div class="col-lg-3 col-md-6 single-blog">
							...
							<a href="https://twitter.com/e100ss"><h4>Info harian seputar jalan raya yang aktual dan terkini</h4></a>
							<p>
						...
						<div class="col-lg-3 col-md-6 single-blog">
							...
							<a href="https://www.youtube.com/watch?v=y0Blq-W0MZM&t=1194s"><h4>Playlist menyenangkan saat di jalan</h4></a>
							<p>
						...
						<div class="col-lg-3 col-md-6 single-blog">
							...
							<a href="https://news.idntimes.com/indonesia/erny/penting-ini-17-nomor-darurat-yang-harus-kamu-ketahui/full"><h4>10 nomor penting yang harus Anda ketahui</h4></a>
							<p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://www.linkedin.com/in/pawitra-gusti-237a44146/" target="_blank">WowotCorp</a>
<!-- \Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. >
						</p>											
					</div>
				</div>
